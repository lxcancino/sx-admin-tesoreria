...
import { RelacionPagosComponent } from './relacionPagos/relacion-pagos.component';
...
export const components: any[] = [
  ...
  CobroFormComponent,
  CobrochequeFormComponent,
  CobrotarjetaFormComponent,
...
export * from './cobrocheque-form/cobrocheque-form.component';
export * from './cobrotarjeta-form/cobrotarjeta-form.component';
export * from './fichas-table/fichas-table.component';
export * from './relacionPagos/relacion-pagos.component';
